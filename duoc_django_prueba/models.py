...
class Usuario(models.Model):
    ...
    run = models.CharField(max_length=11, blank=True, null=True)
    ...
    membresia = models.CharField(max_length=50, blank=True, null=True)
    fecha_nac = models.CharField(max_length=20, blank=True, null=True)
